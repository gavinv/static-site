...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Audiowide|Roboto:300,400,500|Ubuntu+Mono:400,700|Ubuntu:300,400,500&amp;subset=greek,greek-ext,latin-ext" rel="stylesheet">
    <script
  src="https://code.jquery.com/jquery-3.3.1.min.js"
  integrity="sha256-FgpCb/KJQlLNfOu91ta32o/NMZxltwRo8QtmkMRdAu8="
  crossorigin="anonymous"></script>
  <script async="async" type="text/javascript" src="../js/modernizr.custom.js"></script>
  <script async="async" type="text/javascript" src="../js/classie.js"></script>
  </head>
